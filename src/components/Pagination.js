    ...
    return (
      <div className="flex items-center">
        ...
        <ul className="flex items-center justify-end text-sm">
          ...
          {page + 1 === TotalNumber || page === TotalNumber ? (
            <li>
              <button
                ...
                className="outline-0 hover:text-cyan rounded-ful w-8 h-8 flex items-center justify-center text-lg"
              >
                ...
              </button>
            </li>
          ...
          <li>
            <button
              className="flex items-center outline-0 hover:text-cyan w-8"
              onClick={next}
            >

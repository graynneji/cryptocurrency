...
const HighLowIndicator = ({ currentPrice, high, low }) => {
  ...
  return (
    <>
      ...
      <span
        className="bg-green h-1.5 rounded-r-g w-[50%]"
        style={{ width: `${green}%` }}
      >
        &nbsp;
      </span>
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col ">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="test-sm bg-gray-200 text-gray-100px-1.5 py-0.5 my-1 rounded"
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">
                    ...
                    >
                      <span>
                        {Number(
                          data.sentiment_votes_down_percentage.toFixed(2)
                        )}
                        %
                      </span>
                      <svg
